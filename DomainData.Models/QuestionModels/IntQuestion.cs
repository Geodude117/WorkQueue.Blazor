...
{
    public class IntQuestion : IQuestion
    {
        public IntQuestion()
        {
        ...
        [CustomValidation(typeof(IntQuestion), nameof(CustomRequired))]
        public int? Value { get; set; }

        public int QuestionId { get; set; }

        public static ValidationResult CustomRequired(int? value, ValidationContext vc)
        {
